...
**Platform version:** v0.4.2 · **Companion packs:** Workshop Guide pack v1.5.0 · Value Study decks v1.2.0 — see [Release history](#release-history) · [all releases on GitHub](https://github.com/paulojorge1963/value-lifecycle-platform/releases)
...
|---|---|
| **[v0.4.2](https://github.com/paulojorge1963/value-lifecycle-platform/releases/tag/v0.4.2)** | **Demo-kit & maintenance release.** A filled, import-ready **sample VE + VR pair** (ITSM-platform displacement / TCO case, vendor-neutral) referenced across the README, Runbook and Demo Script; the demo-kit diagrams and Solution-Overview deck re-skinned to the MP072 palette; the docs reconciled to the app's actual **solution profiles** (retiring the old construction / manufacturing / SaaS framing); a new **`docs/MAINTENANCE.md`** maintainer guide; and **Prisma Migrate** adopted so schema changes apply automatically on deploy. |
