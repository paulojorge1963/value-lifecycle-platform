...
|---|---|
| **[Discovery Workshop Guide pack](https://github.com/paulojorge1963/blueturtle-workshop-guide-pack/releases)** | **v1.3.0** facilitator question bank · **v1.2.0** value-provenance cheat-sheet · **v1.1.0** 12-workshop agendas · **v1.0.0** workbook, Metric Owners checklist & filled sample |
